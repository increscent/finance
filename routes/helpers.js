...
module.exports = {
  getAccountData: function (req, res, next) {
    Models.Account.findOne({_id: req.headers.account_id}, function (err, account) {
      if (!account) return module.exports.userError(res, 'Account does not exist: ' + req.headers.account_id);
